...
//       let canSave;
//       if(password) {
//         canSave= [roles.length, validateUsername, validatePassword].every(Boolean) && !isLoading
//       }else {
//             canSave = [roles.length, validateUsername].every(Boolean) && !isLoading
//       }

//       const errClass = (isError || isDelError) ? "errmsg" : "offscreen"
//       const validUserClass = !validateUsername ? 'form__input--incomplete' : ""
//       const validPwdClass = !Boolean(roles.length) ? 'form__input--incomplete' : ''
...
//                 <label className="form_label form_checkbox-container" htmlFor="user-active">
//                 ACTIVE:
